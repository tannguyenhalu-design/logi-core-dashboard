 ...
 * Brand loading indicator — a driving truck in the GHN teal/dark palette,
 * shown wherever the dashboard is fetching data.
 */
export default function TruckLoader({ size = 64, label }) {
  ...
  return (
    <div className="truck-loader" style={{ width, margin: label ? "24px auto" : "40px auto" }}>
      <svg
        viewBox="0 0 64 40"
        width={width}
        height={height}
