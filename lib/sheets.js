...
// Exposed for callers (e.g. API routes) that fetch outside fetchSheet()'s
// values.get() path — e.g. spreadsheets.get({includeGridData:true}) for
// hyperlinks/chips — but still want the same cache-and-invalidate pattern.
